...
%   Fiorilli, Ruiz, Sanchez & Esposito (2026), arXiv:2511.16730
    ...
    delta_keys = cell2mat(keys(pars_dict));
    if ismember(Delta_m, delta_keys)
        params = pars_dict(Delta_m);
    else
